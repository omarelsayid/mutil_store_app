...
import '../../../provider/delevierd_order_count_provider.dart';
...
class _AccountScreenState extends ConsumerState<AccountScreen> {
          ...
          return AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  await AuthController().singOutUser(context: context);
                },
                child: Text(
                  "Logout",
                  style: GoogleFonts.montserrat(
  ...
  Widget build(BuildContext context) {
    ...
    int deiverdCount = ref.watch(deliveredOrderCountProvider);
